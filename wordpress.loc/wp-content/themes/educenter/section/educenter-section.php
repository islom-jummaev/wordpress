	...
	function educenter_calltoaction_section() { 
		...
		if( !empty( $cta ) && $cta == 1 ){ 
			...
			if( function_exists( 'pll_register_string' ) ){
				...
				$button_text = pll__( get_theme_mod('educenter_cta_button_text','Batafsil') );
			
			}else{

				$button_text = get_theme_mod('educenter_cta_button_text','Batafsil');
        ...
        <div class="col">
            ...
            <div class="col">
                ...
                <div class="text-holder">
                    ...
                    <h3><a href="#">Elektron kutubxona</a></h3>
                    <a href="#" class="ed-button">
                        Batafsil
                    </a>
            ...
            <div class="col">
                ...
                <div class="text-holder">
                    ...
                    <h3><a href="http://hemis.tdtutf.uz/dashboard/login">Hemis O'qituvchi</a></h3>

                    

                    <a href="http://hemis.tdtutf.uz/dashboard/login" class="ed-button">
                        Batafsil
                    </a>
            ...
            <div class="col">
                ...
                <div class="text-holder">
                    <h3><a href="http://student.tdtutf.uz/dashboard/login">Hemis Talaba</a></h3>
                

                    

                    <a href="http://student.tdtutf.uz/dashboard/login" class="ed-button">
                        Batafsil
                    </a>
            ...
            <div class="col">
                ...
                <div class="text-holder">
                        ...
                        <h3><a href="#">Masofaviy ta'lim</a></h3>
            ...
            <div class="col">
                ...
                <div class="text-holder">
                    ...
                    <h3><a href="https://pf.bimm.uz/">Portfolio</a></h3>

                    

                    <a href="https://pf.bimm.uz/" class="ed-button">
                        Batafsil
                    </a>
            ...
            <div class="col">
                ...
                <div class="text-holder">
                    ...
                    <h3><a href="https://t.me/TMTI379">Ijtimoiy tarmoqlar</a></h3>

                    

                    <a href="https://t.me/TMTI379" class="ed-button">
                        Batafsil
                    </a>
								...
								?>
									...
									<div class="ed-col ed-col-three">
										...
										<div class="ed-text-holder">
											...
											<a href="<?php the_permalink(); ?>" class="ed-button">
												<?php esc_html_e('batafsil','educenter'); ?>
											</a>
										</div>
									</div>
...
if ( ! function_exists( 'educenter_wp_events_section' ) ) :
	...
	*/
	function educenter_wp_events_section() { 
		...
		$wp_events = get_theme_mod( 'educenter_events_area_options', 1 );

		if( !empty( $wp_events ) && $wp_events == 1 ){ ?>
